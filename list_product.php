...
and who!='для мужчин' ORDER BY model DESC LIMIT 1000",$db);
...
<tr>
<td width='210' height='260' rowspan='4' align='center' bgcolor='#D9E9C9' valign='top'>
<img src='img_prod/$myrow_s[tm]-$myrow_s[model].jpg' alt='FOTO'></td> 
...
<tr>
<td align='left' width='100' bgcolor='#D9E9C9'  class='text'>Описание:</td> 
<td align='left' width='270' bgcolor='#D9E9C9'  class='text'>$myrow_s[info_prod] </td> 
</tr>
</table>
<hr>
</td>
...
case 2: 
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and who!='для мужчин' ORDER BY model DESC LIMIT 1000",$db);
$myrow_s= mysql_fetch_array ($result_s);
if ($myrow_s['productID']!='0' and $myrow_s['productID']!='' and (isset ($myrow_s['productID'])))
{do
{ $myrow_s[price]=round($myrow_s[price]*$myrow_price[kurs]*$myrow_price[kof]+$myrow_price[dost]);
...
<tr>
<td width='210' height='260' rowspan='4' align='center' bgcolor='#D9E9C9' valign='top'>
<img src='img_prod/$myrow_s[tm]-$myrow_s[model].jpg' alt='ФОТО'></td> 
<form action='korzinka.php?productID=$myrow_s[productID]' method='post' name=form>
<td align='center' bgcolor='#D9E9C9'  class='name_prod'> <a href=product.php?id=$myrow_s[productID]>$myrow_s[vid]  $myrow_s[tm] $myrow_s[model] </a></td> 
<td width='70' rowspan='2' align='center' bgcolor='#D9E9C9' valign='top'><INPUT type=image src='img/cart_navy.gif' width='57' height='58' name='submit'></input></td>
</tr>
...
<tr>
<td width='100' height='50' align='left' bgcolor='#D9E9C9'  class='text'>Размеры:</td> 
<td width='270' align='left' bgcolor='#D9E9C9'  class='text'>");
...
case 9: 
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and who!='для женщин'ORDER BY model DESC LIMIT 1000",$db);
$myrow_s= mysql_fetch_array ($result_s);
$count=0;
...
<form action='korzinka.php?productID=$myrow_s[productID]' method='post' name=form>
<td align='center' bgcolor='#D9E9C9'  class='name_prod'> <a href=product.php?id=$myrow_s[productID]>$myrow_s[vid]  $myrow_s[tm] $myrow_s[model] </a></td> 
<td width='70' height='58' rowspan='2' align='center' bgcolor='#D9E9C9' valign='top'><INPUT type=image src='img/cart_navy.gif' width='57' height='58' name='submit'></input></td>
</tr>
<tr>
<td bgcolor='#D9E9C9' valign='top' align='center' ><b class='text'>Цена: </b><b class='price'> $myrow_s[price]  </b><b class='text'> грн.</b> <hr></td>
</tr>
...
default:  
{
$result_page = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' ORDER BY model DESC",$db);
...
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' ORDER BY model DESC LIMIT 0, 1000
",$db);
$myrow_s= mysql_fetch_array ($result_s);
...
while ($myrow_s=mysql_fetch_array($result_s));
printf ("... и многое другое! Уточните в правом столбце, что мы ищем!");}
