...
{$cena1=($_POST['cena1']-$myrow_price[dost])/($myrow_price[kurs2]*$myrow_price[kof]);}
else{$cena1=0;}
...
echo "<br><font class='h2'>Выбран раздел - Распродажа</font><br>";
...
{case 1: 
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and who!='для мужчин' and katalog='распродажа' ORDER BY model DESC",$db);
...
{    $size_test=strpos($myrow_s['size'], $sise_sort);
	 ...
	 {   if ($vid_test =='true' or $vid_test !='')
	    ...
	    {$count=1+$count; $myrow_s[price]=round($myrow_s[price]*$myrow_price[kurs2]*$myrow_price[kof]+$myrow_price[dost]);
		printf ("<br>
...
if ($myrow_s['productID']!='0' and $myrow_s['productID']!='' and (isset ($myrow_s['productID'])))
{do
{$myrow_s[price]=round($myrow_s[price]*$myrow_price[kurs2]*$myrow_price[kof]+$myrow_price[dost]); printf ("<br>
<table width='612' border='0'  cellspacing='0' cellpadding='0'>
<tr>
<td width='210' height='260' rowspan='3' align='center' bgcolor='#D9E9C9' valign='top'>
<img src='img_prod/$myrow_s[tm]-$myrow_s[model].jpg' alt='НЕТ ФОТО'></td>  
...
default:  
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and katalog='распродажа' ORDER BY model DESC",$db);
$myrow_s= mysql_fetch_array ($result_s);
if ($myrow_s['productID']!='0' and $myrow_s['productID']!='' and (isset ($myrow_s['productID'])) )
{do
{$myrow_s[price]=round($myrow_s[price]*$myrow_price[kurs]*$myrow_price[kof]+$myrow_price[dost]); printf ("<br>
