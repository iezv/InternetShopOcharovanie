...
$result = mysql_query("SELECT title,meta_d,meta_k,text FROM informacia WHERE page='dostavka'",$db);
...
<form action="send.php" method="post">
 ...
 <tr>
 <td width="1000" colspan="3" align="center" bgcolor="#D9E9C9" class="webstyle">WebStyle Ocharovanie &copy 2012<!-- Yandex.Metrika counter -->
