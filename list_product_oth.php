...
echo "<br><font class='h2'>Выбран раздел - Прочее</font><br>";
...
{case 1: 
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and who!='для мужчин' 
and tm!='AVA' and tm!='KINGA' and tm!='GAIA' and tm!='DOBRA NOCKA' and tm!='LUPO' and tm!='SHATO' and tm!='KRIS LINE' and tm!='MIRABELLE' and tm!='MITEX' and tm!='EWANA' and tm!='JULIMEX' and tm!='CORIN'and tm!='FABIO' ORDER BY model DESC",$db);
...
<tr>
 <td  bgcolor='#D9E9C9' valign='top' align='center' align='center'><b class='text'>Цена: </b><b class='price'> $myrow_s[price]  </b><b class='text'> грн.</b> <hr></td>
</tr>
<tr>
...
case 9: 
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and who!='для женщин' 
and tm!='AVA' and tm!='KINGA' and tm!='GAIA' and tm!='DOBRA NOCKA' and tm!='LUPO' and tm!='SHATO' and tm!='KRIS LINE' and tm!='MIRABELLE' and tm!='MITEX' and tm!='EWANA' and tm!='JULIMEX' and tm!='CORIN'and tm!='FABIO' ORDER BY model DESC",$db);
$myrow_s= mysql_fetch_array ($result_s);
$count=0;
...
<table width='370' border='0'  cellspacing='5' cellpadding='5'>
<tr>
<td width='100' height='25' align='left' bgcolor='#D9E9C9'  class='text'>Код товара</td> 
<td width='270' align='left' bgcolor='#D9E9C9'  class='text'>$myrow_s[productID]</td> 
</tr>
<tr>
<td width='100' align='left' bgcolor='#D9E9C9'  class='text'>Цвет</td> 
