...
echo "<br><font class='h2'>Выбрана ТМ - $tm</font><br>";
...
{case 1: 
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and who!='для мужчин' and (tm='$tm') and (katalog!='$kk') ORDER BY model DESC",$db);
...
case 9: 
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and who!='для женщин' and (tm='$tm') and (katalog!='$kk')  ORDER BY model DESC",$db);
$myrow_s= mysql_fetch_array ($result_s);
$count=0;
...
default:  
{
$result_s = mysql_query ("SELECT * FROM products WHERE price >= '$cena1' and price <= '$cena2' and (tm='$tm') and (katalog!='$kk')  ORDER BY model DESC",$db);
$myrow_s= mysql_fetch_array ($result_s);
if ($myrow_s['productID']!='0' and $myrow_s['productID']!='' and (isset ($myrow_s['productID'])) )
{do
{$myrow_s[price]=round($myrow_s[price]*$myrow_price[kurs]*$myrow_price[kof]+$myrow_price[dost]);
